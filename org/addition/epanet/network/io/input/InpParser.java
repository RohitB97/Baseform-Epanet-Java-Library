...
public class InpParser extends InputParser {
    ...
    private void parsePC(Network net, InputStream inStream1) throws ENException {
        int errSum = 0;
        int lineCount = 0;
        ...
        try {
            buffReader = new BufferedReader(new InputStreamReader(inStream1, "ISO-8859-1"));
        } catch (IOException e) {
    ...
    // Parse INP file
    public Network parse(Network net, InputStream inStream1, InputStream inStream2) throws ENException {

        parsePC(net, inStream1);
        ...
        try {
            buffReader = new BufferedReader(new InputStreamReader(inStream2, "ISO-8859-1"));
        } catch (IOException e) {
            throw new ENException(302);
        }
